...
*/}}
{{- define "huna.labels" -}}
helm.sh/chart: {{ include "huna.chart" . }}
{{ include "huna.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
*/}}
{{- define "huna.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "huna.fullname" .) .Values.serviceAccount.name }}
{{- else }}
